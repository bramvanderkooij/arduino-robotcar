...
//Array, with images to display on screen
...
void avoid()
{
  ...
  if((distance < 30)&&(distance > 0))//if the distance is greater than 0 and less than 20
  {car_turn();
  goto reset;}

  else{
  servopulse(servopin,100);//servo rotates to 110°
    delay(150);
  distance=sr04.Distance();} //obtain the value detected by ultrasonic sensor
  ...
  servopulse(servopin,90);//servo rotates to 90°
    delay(150);
  distance=sr04.Distance();} //obtain the value detected by ultrasonic sensor
  ...
  servopulse(servopin,80);//servo rotates to 70°
    delay(150);
  distance=sr04.Distance();} //obtain the value detected by ultrasonic sensor 
...
void car_turn()//turn around to avoid things
{
car_Stop();//stop
